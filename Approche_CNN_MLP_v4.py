...
os.makedirs("runs/convnext_tiny", exist_ok=True)
...
for epoch in range(N_EPOCHS):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(model_convnext.state_dict(), "runs/convnext_tiny/convnext_tiny_best.pth")
...
model_convnext.load_state_dict(torch.load("runs/convnext_tiny/convnext_tiny_best.pth", map_location=device))
model_convnext.eval()
...
model_convnext.load_state_dict(
    torch.load("runs/convnext_tiny/convnext_tiny_best.pth", map_location=device)
)
model_convnext.eval()
