...
os.makedirs("runs/efficientnet_b3", exist_ok=True)

model_effnet = efficientnet_b3(
...
for epoch in range(N_EPOCHS):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(model_effnet.state_dict(), "runs/efficientnet_b3/efficientnet_b3_best.pth")
...
model_effnet.load_state_dict(torch.load("runs/efficientnet_b3/efficientnet_b3_best.pth", map_location=device))
model_effnet.eval()
...
model_effnet.load_state_dict(
    torch.load("runs/efficientnet_b3/efficientnet_b3_best.pth", map_location=device)
)
model_effnet.eval()
